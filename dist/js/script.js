...
/* harmony export */ });
/* harmony import */ var _css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(547);
/* harmony import */ var _css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(532);
...
function FlatpickrInstance(element, instanceConfig) {
  ...
  function isEnabled(date, timeless) {
    ...
    for (var i = 0, d = void 0; i < array.length; i++) {
      ...
      } else if (esm_typeof(d) === "object" && dateToCheck !== undefined && d.from && d.to && dateToCheck.getTime() >= d.from.getTime() && dateToCheck.getTime() <= d.to.getTime()) return bool;
    }
    return !bool;
  }
  ...
  function setupLocale() {
    if (esm_typeof(self.config.locale) !== "object" && typeof flatpickr.l10ns[self.config.locale] === "undefined") self.config.errorHandler(new Error("flatpickr: invalid locale " + self.config.locale));
    self.l10n = __assign(__assign({}, flatpickr.l10ns.default), esm_typeof(self.config.locale) === "object" ? self.config.locale : self.config.locale !== "default" ? flatpickr.l10ns[self.config.locale] : undefined);
  ...
  function set(option, value) {
    if (option !== null && esm_typeof(option) === "object") {
  ...
  function parseDateRules(arr) {
    return arr.slice().map(function (rule) {
      ...
      } else if (rule && esm_typeof(rule) === "object" && rule.from && rule.to) return {
...
var setAttributesWithoutAttributes = __webpack_require__(675);
...
var flatpickr_min = __webpack_require__(921);
